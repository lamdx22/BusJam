...
public class TweenPosition : UITweener
{
	...
	[HideInInspector]
	public bool rectPos = false;

	Transform mTrans;

	public Transform cachedTransform { get { if (mTrans == null) mTrans = transform; return mTrans; } }
	public RectTransform rectTransform {get { return cachedTransform as RectTransform; }}
	...
	public Vector3 value
	{
		get
		{
			...
			if (rectPos && rectTrans) return rectTrans.anchoredPosition;
			return worldSpace ? cachedTransform.position : cachedTransform.localPosition;
		}
		set
		{
			var rectTrans = rectTransform;
			if (rectPos && rectTrans) {
