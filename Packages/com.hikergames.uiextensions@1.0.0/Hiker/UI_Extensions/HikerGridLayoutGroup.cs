...
namespace Hiker.UI
{
    ...
    /// <summary>
    /// duongrs
    /// clone script cua UnityUI de fix cai setting FixedColumCount thuc su la fixed
    /// ^_^
    /// </summary>
    public class HikerGridLayoutGroup : LayoutGroup
    {
        /// <summary>
        ...
        protected HikerGridLayoutGroup()
        { }
        ...
        private void SetCellsAlongAxis(int axis)
        {
            ...
            if (startAxis == Axis.Horizontal)
            {
                ...
                if (m_Constraint == Constraint.FixedColumnCount)
                {
                    actualCellCountX = m_ConstraintCount;
                }
                else
                {
            ...
            else
            {
                ...
                {
                    actualCellCountY = m_ConstraintCount;
                }
                else
                {
