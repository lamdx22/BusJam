...
namespace Hiker.UI
{
    [CustomEditor(typeof(HikerScrollRect), true)]
    ...
    /// </summary>
    public class HikerScrollRectEditor : Editor
    {
        SerializedProperty m_Content;
        SerializedProperty m_CheckAllBoundContent;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_CheckAllBoundContent = serializedObject.FindProperty("m_CheckAllBoundContent");
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((HikerScrollRect)target).transform;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_CheckAllBoundContent);
